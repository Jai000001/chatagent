...
class GetCollectionStreamingDataService:
    def __init__(self):
        pass

    async def get_collection_streaming_data_async(self, request, client_id, dept_id):
        try:
            ...
            return StreamingResponse(
                qdrant_handler.stream_qdrant_collection_data(client_id, dept_id=dept_id),
